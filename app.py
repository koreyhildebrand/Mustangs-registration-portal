...
# ====================== VERSION CONTROL ======================
VERSION = "v3.13"  # Fixed Restricted Health tab visibility for ReadWrite users with Restricted:Write permission
...
if authentication_status is True:
    ...
    # FIXED: Check both roles and permissions for Restricted access
    ...
    st.sidebar.write("**Permissions:**", ", ".join(permissions) if permissions else "None")  # debug line
