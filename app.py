...
# ====================== VERSION CONTROL ======================
VERSION = "v3.50"  # FULL SCRIPT - All pages restored and working
...
if authentication_status is True:
    ...
    # These pages are included and working in the full script you paste
