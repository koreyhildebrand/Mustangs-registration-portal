...
if "authenticator" not in st.session_state:
    try:
        ...
        st.info("Make sure the sheet 'RegistrationPortal' is shared with your service account email as Editor.")
        st.stop()
...
if authentication_status is True:
    ...
    # Add the other pages (Restricted Health, Camps, Admin, Profile) as in previous versions if needed
