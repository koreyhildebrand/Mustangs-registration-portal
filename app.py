...
if "authenticator" not in st.session_state:
    ...
    sheet = None  # Will be initialized after login
    user_records = []
    try:
        # Temporary minimal authenticator
...
if authentication_status is True:
    ...
    if page == "📋 Players":
        ...
        st.info("Full user permission editor coming soon.\n\nYou can edit users and roles directly in the **Users** sheet for now.")

    elif page == "🏕️ Camps":
        st.header("🏕️ Camps & Training Sessions")
        st.info("Camps management section is ready for expansion.")
    ...
    st.caption("✅ St. Vital Mustangs Registration Portal | Full Version")
