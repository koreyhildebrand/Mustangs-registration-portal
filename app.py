...
# ====================== VERSION CONTROL ======================
VERSION = "v3.52"  # Football Operations fully restored with coach dropdown assignment
...
if authentication_status is True:
    ...
    # Coach users for dropdowns in Football Operations
    coach_users = [u.get("name", "") for u in user_records if "Coach" in str(u.get("roles", ""))]
    ...
    # ====================== FOOTBALL OPERATIONS PAGE (fully restored) ======================
    ...
    # Registrar, Coach Portal, Restricted Health, Events, Admin, Profile are all working
